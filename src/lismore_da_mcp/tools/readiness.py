...
PROPOSAL_ARGUMENTS = {
    ...
    'floor_area_sqm': {'type': 'number', 'description': 'Optional. Gross floor area in square metres.'},
    'spaces_provided': {'type': 'integer', 'description': 'Optional. Car parking spaces available on the site.'},
