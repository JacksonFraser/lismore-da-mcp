...
@tool(
    ...
    properties={
        ...
        'site_area_sqm': {'type': 'number', 'description': 'Site area in square metres', 'minimum': 0},
        ...
        'floor_area_sqm': {'type': 'number', 'description': 'Gross floor area of the proposal in square metres', 'minimum': 0},
        ...
        'num_employees': {'type': 'integer', 'description': 'Number of employees', 'minimum': 0},
        'num_customers': {'type': 'integer', 'description': 'Maximum number of customers/patrons at any time', 'minimum': 0},
        'estimated_cost': {'type': 'number', 'description': 'Estimated cost of development works in dollars', 'minimum': 0},
        ...
        'existing_parking_spaces': {'type': 'integer', 'description': 'Number of existing on-site parking spaces (0 if none)', 'minimum': 0},
...
'floor_area_sqm': {'type': 'number', 'description': 'Floor area in square metres', 'minimum': 0},
...
'num_employees': {'type': 'integer', 'description': 'Number of employees', 'minimum': 0},
'num_customers': {'type': 'integer', 'description': 'Maximum customers at any time', 'minimum': 0},
'estimated_cost': {'type': 'number', 'description': 'Estimated cost of works in dollars', 'minimum': 0},
...
'parking_spaces_provided': {'type': 'integer', 'description': 'Off-street parking spaces provided on site. Compared against the DCP Chapter 7 rate so any shortfall is stated.', 'minimum': 0},
